...
parcelHelpers.export(exports, "setCounter", ()=>setCounter);
var _circleAnimation = require("./src/js/2d/animations/circle/circleAnimation");
...
parcelHelpers.export(exports, "circleAnimation", ()=>circleAnimation);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _circlePath = require("./circlePath");
var _ = require("../../../../..");
var _showAnimation = require("../showNav/showAnimation");
const tl3 = (0, _gsapDefault.default).timeline({
    paused: true
});
function circleAnimation(spiner, navBar, line, horisontalLines, liSpan) {
    tl3.play();
    tl3.to(navBar, {
        x: 0,
        duration: 0.01
    });
    (0, _circlePath.paths).forEach((path, index)=>{
        tl3.to(spiner, {
            clipPath: path,
            duration: index % 2 === 0 ? 0.01 : 0.02,
            onComplete: index === (0, _circlePath.paths).length - 1 ? ()=>{
                if ((0, _.counter) === 0) (0, _showAnimation.showAnimation)(line, horisontalLines, liSpan);
                tl3.pause();
            } : null
        });
    });
...
},{"gsap":"fPSuC","./circlePath":"9CoE4","../../../../..":"bB7Pu","../showNav/showAnimation":"3IVYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9CoE4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3IVYd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showAnimation", ()=>showAnimation);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _ = require("../../../../..");
...
function showAnimation(line, horisontalLines, liSpan) {
    tl.play();
    tl.add("start");
    tl.to(line, {
        scaleY: 1,
...
},{"gsap":"fPSuC","../../../../..":"bB7Pu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5KK5P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _ = require("../../../../..");
var _circleAnimation = require("../circle/circleAnimation");
const tl2 = (0, _gsapDefault.default).timeline({
    paused: true
});
function hideAnimation(line, liSpan, horisontalLines, navBar) {
    tl2.add("start");
    tl2.play();
    horisontalLines.forEach((line, index)=>{
        tl2.to(line, {
    ...
    (0, _gsapDefault.default).delayedCall(1, ()=>(0, _circleAnimation.tl3).reverse());
    tl2.to(navBar, {
        x: 400,
        duration: 0.01,
        delay: 0.4
...
},{"gsap":"fPSuC","../../../../..":"bB7Pu","../circle/circleAnimation":"kSlU9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jEJtz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mouseLeave", ()=>mouseLeave);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function mouseLeave(horisontalLines) {
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5oeD2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mouseMove", ()=>mouseMove);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function mouseMove(horisontalLines, e) {
    let lineWidth = 10;
    let lineUp = true;
    ...
    line.forEach((singleLine)=>{
        ...
        if (y + 75 >= Number(linePosition.top.toFixed(0)) && Number(linePosition.top.toFixed(0)) > y - 25) {
            (0, _gsapDefault.default).to(singleLine, {
                duration: 0.5,
                x: 80 - lineWidth
            });
            if (lineUp) {
        ...
        } else (0, _gsapDefault.default).to(singleLine, {
            duration: 0.5,
            x: 80
        });
    });
